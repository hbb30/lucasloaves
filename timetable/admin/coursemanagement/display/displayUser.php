...
if(isset($_POST['search'])){
    ...
    $sql = "SELECT courseid, course_name, course_room, course_sched, course_teacher FROM tbl_course";
}
...
if($result_set){
    foreach($conn->query($sql) as $row){ 
        ...
        <tr>
            ...
            <td><button class="btn btn-sm btn-outline-warning" onclick="editUser(<?=$row['courseid'];?>)">
